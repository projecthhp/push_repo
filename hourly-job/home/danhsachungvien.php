...
<body>
            ...
            <div class="row">
                <div class="col-xl-8 bg-white">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">LỌC ỨNG VIÊN</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid">
                                            <div class="div_ngaydang">
                                                <h2>Ngày đăng</h2>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkboxmt-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck1" />
                                                            <label class="custom-control-label" for="customCheck1">Tất
                                                                cả</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">7
                                                                ngày trước</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkboxmt-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck1" />
                                                            <label class="custom-control-label" for="customCheck1">30
                                                                ngày trước</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">24
                                                                giờ trước</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">14
                                                                ngày trước</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkboxmt-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck1" />
                                                            <label class="custom-control-label" for="customCheck1">Bán
                                                                hàng</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Vận
                                                                chuyển/bốc vác</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Nhà
                                                                hàng/khách sạn</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Nấu
                                                                ăn/đầu bếp</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkboxmt-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck1" />
                                                            <label class="custom-control-label" for="customCheck1">Phục
                                                                vụ/tạp vụ</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Hành
                                                                chính</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Tổ
                                                                chức sự kiện</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Xây
                                                                dựng/công trình</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2"> Giao
                                                                hàng </label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2"> Kho
                                                                bãi</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkboxmt-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck1" />
                                                            <label class="custom-control-label" for="customCheck1">Hà
                                                                Nội</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Bình
                                                                Dương</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkboxmt-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck1" />
                                                            <label class="custom-control-label" for="customCheck1">TP.Hồ
                                                                Chí Minh </label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2">Cần
                                                                Thơ</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="customCheck2" />
                                                            <label class="custom-control-label" for="customCheck2"> Đà
                                                                Nẵng </label>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="div_congviec">
                        <h5>Danh sách ứng viên theo giờ</h5>
                        <?
                        $query = "SELECT * FROM `vltg_user_uv`";
                        $db_qr = new db_query($query);
                        While($value = mysql_fetch_assoc($db_qr->result)){
                      ?>
                        <div class="div_thongtin bg-white">
                            <div class="div_anhungvien">
                                <img src="../public/images/<?= $value['file_image'] ?>" alt="">
                            </div>
                            <div class="div_text">
                                <a href="" class=""><?= $value['name_uv'] ?></a>
                            </div>
                            <div class="div_box">
                                <div class="div_tennhanvien">Nhân viền bồi bàn</div>
                                <div class="div_mapungvien">
                                    <i style="font-size: 13px" class="fas">&#xf3c5;</i>
                                    <?= $value['diachi_uv'] ?>
                                </div>
                                <div class="div_thoigianungvien">
                                    <i style="font-size: 13px" class="fa">&#xf017;</i>
                                    1 giờ trước
                                </div>
                            </div>
                            <div class="div_boder1">
                                <div class="icon_div">
                                    <a href="">
                ...
                <div class="col-sm-4 bg-white">
                    <div class="div_congviec1">
                        ...
                        <form action="">
                            ...
                            <div class="custom-control custom-checkbox checkbox_vieclam mt-2">
                                ...
                                <label class="custom-control-label" for="customCheck11">Xây dựng / Công trình</label>
                            </div>
                            <div class="custom-control custom-checkbox checkbox_vieclam mt-2">
                    ...
                    <div class="div_bennerungvien">
                        <img src="../image/Group 2321.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="div_benner">
        <img src="../image/Group 2071.png" alt="" />
    </div>
