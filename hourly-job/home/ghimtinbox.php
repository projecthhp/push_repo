...
<head>
  ...
  <title>Ghim box làm việc mới nhất</title>
  <link
  rel="stylesheet"
  type="text/css"
...
<div class="h_banggiadichvu">
  ...
  <div class="row h_row_banggiadichvu h_row_nhanxet">
    ...
    <div class="h_cacgoighimtin h_pc_lochoso h_ghim_tin_tablet">
      <div class="container">
        <div class="row">
          <!-- <div class="d-flex flex-column-reverse flex-lg-row"> -->
            <div class="col-md-6 h-col_img_ghimtin h_ghim_tin_box">
              <img src="../image/Group.tin.png" alt="">
            </div>
            <div class="col-md-6 h-col_img_ghimtin1 h_lochoso">
              <h2>ghim tin box việc làm theo giờ mới nhất</h2>
          ...
          <div class="h_textghim_icon">
          <div class="h_rotate_ghimtin1">
            <div class="h-rotate-icon_loc h-rotate-icon_loc1">
              <i style='font-size:20px' class='fas'>&#xf00c;</i>
            </div>
        ...
        <div class="h_col_thongtin_lochoso">
          <div class="">
            <div class="row h-row-noidung-hoso h_row_ghimtin">
              <div class="col-md-6">
...
<div class="col-md-6">
  ...
  <div class="h_muangay_hoso">
   <a href="">Mua ngay</a>
    ...
    <div class="h_cacgoighimtin h_ghimtin_box_pc">
      <div class="container">
        <div class="row">
          <!-- <div class="d-flex flex-column-reverse flex-lg-row"> -->
            <div class="col-md-6 h-col_img_ghimtin h_ghim_tin_box">
        ...
        <div class="h_table_lochoso h_ghim_tin_pc h_ghim_tin_table">
