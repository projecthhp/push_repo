...
<head>
  ...
  <title>Ghim box làm việc theo giờ lương cao</title>
  <link
  rel="stylesheet"
  type="text/css"
...
<div class="h_banggiadichvu">
  ...
  <div class="row h_row_banggiadichvu h_row_nhanxet">
...
<div class="h_cacgoighimtin">
  <div class="container">
    <div class="row">
      <div class="col-md-6 h-col_img_ghimtin h_ghim_tin_box">
        <img src="../image/Frame (2)luongcao.png" alt="">
      </div>
      <div class="col-md-6 h-col_img_ghimtin1 h_lochoso">
        <h2>ghim tin box việc làm theo giờ lương cao</h2>
        <div class="h_rotate_ghimtin1">
         <div class="h-rotate-icon_loc">
           <i style='font-size:20px' class='fas'>&#xf00c;</i> 
         </div>
         <p>Bảo hành tin đăng:<span> Sau thời hạn ghim tin, nếu không có hồ sơ ứng tuyển sẽ tiếp tục được ghim tin tại vị trí đó với khoảng thời gian tương ứng.</span></p>
       </div>
       <div class="h_rotate_ghimtin1 h_rotate_ghimtin2">
        <div class="h-rotate-icon_loc">
          <i style='font-size:20px' class='fas'>&#xf00c;</i>
        </div>
        <p>Cơ chế hoàn điểm :<span>  Bảo lưu tin đăng (áp dụng từ ghim tin 2 tuần trở lên): Tin đăng sẽ được bảo lưu 3 tháng tiếp theo (tính từ ngày cuối cùng sử dụng dịch vụ) nếu thời gian dịch vụ còn lại trên 1 tuần.</span></p>
      </div>
      <div class="h_rotate_ghimtin1 h_rotate_ghimtin2">
        <div class="h-rotate-icon_loc">
          <i style='font-size:20px' class='fas'>&#xf00c;</i>
        </div>
        <p> Được đổi tin ghim (áp dụng từ ghim tin 2 tuần trở lên)<span> không giới hạn số lần trong thời gian đăng ký chính với các gói có thời hạn ghim tin từ 1 tuần trở lên tùy theo nhu cầu tuyển dụng của các đơn vị ( không hỗ trợ đổi tin trong thời hạn bảo hành).</span></p>
      </div>
      <!-- </div> -->
    </div>
    <div class="h_textghim_icon h_textghim_icon1">
      <div class="h_rotate_ghimtin1">
        <div class="h-rotate-icon_loc">
          <i style='font-size:20px' class='fas'>&#xf00c;</i>
        </div>
  ...
  <div class="h_table_lochoso h_table_tablet_luongcao">
    <table class="table table-bordered">
      ...
      <tbody>
        <tr class="h_loc_tr_icon">
          ...
          <td>0</td>
          <td>
            <!-- <div class="dropdown h_menu1">
                <a class="h_dropbtn">
                    <img src="../image/Vector (1hoa).png" alt="">
                </a>
                <div class="dropdown-content h_main">
                  <div class="h_quyenloi_content h_quyenloi">
                   <h5>Ưu đãi</h5>
                 </div>
...
<div class="h_sudungdichvu">
  <button type="button" class="btn h_btn_thanhtoan" data-toggle="modal" data-target="#exampleModalThanhtoan">
    Sử dụng dịch vụ này
  </button>
  <div class="modal fade" id="exampleModalThanhtoan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelThanhtoan" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content modal_content_thanhtoan">
        <div class="modal-header h_modal-header_thanhtoan">
          <h5 class="modal-title" id="exampleModalLabelThanhtoan">thanh toán dịch vụ</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body h_modal_body_thanhtoan">
          <p>Bước 1: Chuyển tiền qua Internet Banking</p>
          <div class="row">
            <div class="col-md-6">
              <div class="h_nhanhang_thanhtoan">
                <div class="row">
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1.png" alt="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1 (1).png" alt="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1 (2).png" alt="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1 (3).png" alt="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1 (4).png" alt="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1 (5).png" alt="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1 (6).png" alt="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="h_ten_nganhang">
                      <img src="../image/image 1 (7).png" alt="">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="h_nhanhang_thanhtoan1">
                <h2>THÔNG TIN TẢI KHOẢN BIDV</h2>
                <div class="h_thongtintaikhoan">
                  <!-- <h2>THÔNG TIN TẢI KHOẢN BIDV</h2> -->
                   <img src="../image/image 1.png" alt="">
                  <p>Số tài khoản: <span>21610000462781</span></p>
                  <p>Chủ tài khoản: <span>DƯƠNG THỊ MINH TUYỂN</span></p>
                  <p>Chi nhánh<span>Đống Đa, Hà Nội</span></p>
                  <p>Nội dung chuyển khoản:<span>[Tên công ty] su dung dich vụ timviec365 </span></p>
                  <p>Ví dụ:<span>cong ty abc su dung dich vu timviec365</span></p>
                </div>
              </div>
            </div>
          </div>
          <div class="h_buoc2"><p> Bước 2: Thông báo cho chuyên viên hỗ trợ hoặc hotline <span> 0329 39.88.58 | 024 36.36.66.99 </span></p></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="h_col_thongtin_lochoso">
  ...
  <div class="h_muangay_hoso">
   <!-- <a href="">Mua ngay</a> -->
   <button type="button" class="btn h_btn_thanhtoan1" data-toggle="modal" data-target="#exampleModalThanhtoan1">
    Mua ngay
  </button>
  <div class="modal fade" id="exampleModalThanhtoan1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelThanhtoan1" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content modal_content_thanhtoan">
        <div class="modal-header h_modal-header_thanhtoan">
          <h5 class="modal-title" id="exampleModalLabelThanhtoan">thanh toán dịch vụ</h5>
        ...
        <div class="modal-body1 h_modal_body_thanhtoan">
          <p>Bước 1: Chuyển tiền qua Internet Banking</p>
          <div class="row">
            <div class="col-lg-6">
              <div class="h_nhanhang_thanhtoan">
            ...
            <div class="col-lg-6">
              <div class="h_nhanhang_thanhtoan1">
                ...
                <div class="h_thongtintaikhoan">
                  <!-- <h2>THÔNG TIN TẢI KHOẢN BIDV</h2> -->
                 <b><img src="../image/image 1.png" alt=""></b>
                  <p>Số tài khoản: <span>21610000462781</span></p>
                  <p>Chủ tài khoản: <span>DƯƠNG THỊ MINH TUYỂN</span></p>
                  <p>Chi nhánh<span>Đống Đa, Hà Nội</span></p>
                  <p>Nội dung chuyển khoản:<span>[Tên công ty] su dung dich vụ timviec365 </span></p>
...
<div class="h_cacgoighimtin h_ghimtin_b">
  <div class="container">
    <div class="row">
