...
$db_seo = new db_query("SELECT * FROM seo_tt WHERE name_page = 'giai-quyet-tranh-chap'");
...
<!-- End Google Tag Manager -->
   ...
   <body class="lienhe link_chantrang">
      ...
      <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PQGTCFD" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
