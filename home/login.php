...
<section class="login_general main">
   ...
   <div class="right_top">
      <div class="item company">
         <i class="icon"></i>
         <a href="/dang-nhap-nha-tuyen-dung.html">ĐĂNG NHẬP NHÀ TUYỂN DỤNG</a>
      </div>
      <div class="item candidate">
         <i class="icon"></i>
         <a href="/dang-nhap-ung-vien.html">ĐĂNG NHẬP ỨNG VIÊN</a>
      </div>
      <p class="text-center">Bạn chưa có tài khoản?<a href="/dang-ky-chung.html">Đăng ký</a></p>
   </div>
   <div class="left_top">
