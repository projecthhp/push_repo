...
if(isset($_POST['Submit']))
{
   ...
   if($username != '' && $password != '')
   {
      ...
      if(mysql_num_rows($db_qr->result) > 0)
      {
		 ...
		 update('user_company',['usc_time_signin'=>time()],['usc_id'=>$row['usc_id']]);
         header('Location: /nha-tuyen-dung/thong-tin-chung.html');
      }  
      else
      {
         $fail = 1;
...
<!-- End Google Tag Manager (noscript) -->
		...
		<div class="main">
			...
			<div class="right_top">
				...
				<p class="tit_login">Đăng nhập tài khoản nhà tuyển dụng</p>
				<form action="" onsubmit="return valiLoginNtd()" method="POST">
					...
					<a href="/quen-mat-khau-nha-tuyen-dung.html" class="forget_pass">Quên mật khẩu</a>
					<button type="submit" name="Submit">Đăng nhập</button>
					<p class="last">Bạn chưa có tài khoản? <a href="/dang-ky-nha-tuyen-dung.html">Đăng ký ngay</a></p>
				</form>
			</div>
		</div>
		<? 
