                ...
                <div class="M-GeneralManagement-right-content3 M-Freelancer-da-dat-gia-right-content3">
                    <style>
                        ...
                        .M-table1-head #td-head1{
                            ...
                            .M-table-freelancer-da-luu #td-body3 .text{
                                background: #FFFFFF;
                            ...
                            .M-table-freelancer-da-luu #td-body3 .text.end{
                                background: #3980D4;
                                color: white;
                            }
                            .M-table-freelancer-da-luu #td-body3 .ky-nang{
                                margin-top: 25px;
                                margin-bottom:25px;
                                width:90%;
                                margin: 0 auto;
                            }
                            .M-table2-head.M-freelancer-da-luu-table-head #td-head3{
                                    width:275px;
                                }
                            .M-table2-head.M-freelancer-da-luu-table-head #td-head1{
                                width:201px;
                            }
                            .M-table-freelancer-da-luu #td-body1 a{
                                color: #F8971C;
                            }
                            .M-table-freelancer-da-luu #td-body2{
                                font-size: 16px;
                                line-height: 24px;
                                text-align: center;
                                color: #3980D4;
                            ...
                            @media screen and (max-width: 1024px) {
                                ...
                                .M-Freelancer-da-luu-right-content2-mobile2{
                                    width:92%;
                                    margin:0 auto;
                                    border-bottom: 0.3px solid #C1C1C1;
                                    margin-top:15px;    
                                }
                                .M-Freelancer-da-luu-right-content2-mobile2-text1 .text1{
                                    float:left;
                                    font-size: 16px;
                                    line-height: 24px;
                                    color: #09182B;
                                ...
                                .M-Freelancer-da-luu-right-content2-mobile2-text1 .text2{
                                    float:left;
                                    margin-left:10px;
                                    margin-top:2px;
                                }
                                .M-Freelancer-da-luu-right-content2-mobile2-text1 .text2 i{
                                    color:#FFC700;
                                }
                                .M-Freelancer-da-luu-right-content2-mobile2-text1 .text3{
                                    float:right;
                                    margin-top:2px;
                                }
                                .M-Freelancer-da-luu-right-content2-mobile2-text2{
                                    clear:both;
                                    padding-top:8px;
                                }
                                .M-Freelancer-da-luu-right-content2-mobile2-text2 .text1{
                                    float:left;
                                    font-size: 15px;
                                    line-height: 153.69%;                           
                                    color: #3980D4;
                                ...
                                .M-Freelancer-da-luu-right-content2-mobile2-text2 .text2{
                                    float:left;
                                    float:left;
                                    font-size: 15px;
                                    line-height: 153.69%;                           
                                ...
                                .M-Freelancer-da-luu-right-content2-mobile2-text2 .text2 img{
                                    margin-right:5px;
                                }
                                .M-Freelancer-da-luu-right-content2-mobile2-text3{
                                    clear:both;
                                    padding-top:9px;
                                    padding-bottom:21px;
                                }
                                .M-Freelancer-da-luu-right-content2-mobile2-text3 .text{
                                    background: #F8F8F8;
                                    border: 0.5px solid #E0E0E0;
                                    box-sizing: border-box;
                                    border-radius: 100px;
                                ...
                                .M-Freelancer-da-luu-right-content2-mobile2-text3 .end{
                                    background: #3980D4;
                                    color:white;
                                }
                            }
                    ...
                    <div class="M-GeneralManagement-right-content2-table1">
                        <table class="M-table1" id="M-table1">
                            <tr class="M-table1-head M-table2-head M-freelancer-da-luu-table-head">
                                <th id="td-head1">Tên Freelancer</th>
                                <th id="td-head2">Ngành nghề</th>
                                <th id="td-head3">Kỹ năng</th>
                                <th id="td-head4">Địa chỉ</th>
                                <th id="td-head6" >Đánh giá</th>
                                <th id="td-head5" >Xóa</th>    
                            </tr>
                            <tr class="M-table1-body M-table2-body M-table-freelancer-da-luu">
                                <td id="td-body1">
                                ...
                                <td id="td-body3" class="">
                                    <div class="ky-nang d-flex flex-wrap">
                                        <div class="text">Thiết kế website</div>
                                        <div class="text">Thiết kế logo</div>
                                        <div class="text">Ilusstrator</div>
                    ...
                    <div class="M-Freelancer-da-luu-right-content2-mobile2">
                        <div class="M-Freelancer-da-luu-right-content2-mobile2-text1">
                            <div class="text1">Nguyễn Văn Bảo</div>
                            <div class="text2">
                                <div class="Star">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                        ...
                        <div class="M-Freelancer-da-luu-right-content2-mobile2-text2">
                            <div class="text1">Chuyên viên lập trình</div>
                            <div class="text2">
                                <img src="../image/icon/location 1.png" alt="">Hồ Chí Minh
                            </div>
                        </div>
                        <div class="M-Freelancer-da-luu-right-content2-mobile2-text3">
                            <div class="ky-nang d-flex flex-wrap">
