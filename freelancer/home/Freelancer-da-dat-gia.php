    ...
    <head>
        ...
        <title>Freelancer đã đăth giá</title>
        <!-- CSS -->
...
>>>>>>> 12bb0cb9ff663446bb65b5a9c100a529c228166a
                    ...
                    <div class="M-GeneralManagement-right-content2-table1">
                        <table class="M-table1" id="M-table1">
                            ...
                            <tr class="M-table1-body M-table2-body">
                                ...
                                <td id="td-body5">
                                <button class="btn-call" data-toggle="modal" data-target="#modelId"><img src="../image/icon/Group 2540.png" alt=""></button>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body btn-modal-call-body">
                                                    ...
                                                    <p>Bạn có <a style="color: #F8971C;">10</a> điểm hôm nay. Bạn có muốn dùng <a style="color: #FF0000">1 điểm</a> để xem số điện thoại Freelancer này không?</p>
                                            </div>
                                            <div class="modal-footer">
                                                    <button type="button" class="btn-modal-call-button1">Đồng ý</button>
                                                <button type="button" class="btn-modal-call-button2" data-dismiss="modal">Hủy bỏ</button>
                    ...
                    <div class="M-GeneralManagement-right-content2-mobile2">
                        ...
                        <div class="M-GeneralManagement-right-content2-mobile-text2">
                            ...
                            <div class="M-GeneralManagement-right-content2-mobile-text2-btn"> <button class="btn-call" data-toggle="modal" data-target="#modelId1"><img src="../image/icon/Group 2540.png" alt=""></button>Liên Hệ</div>
                                <!-- Modal -->
                    ...
                    <?php
                        for ($i=0; $i <5 ; $i++){
                            ...
                            <div class="M-GeneralManagement-right-content2-mobile2">
                                ...
                                <div class="M-GeneralManagement-right-content2-mobile-text2">
                                    <a href="">Nguyễn Thị Hà My</a>
                                    <div> <button class="btn-call" data-toggle="modal" data-target="#modelId"><img src="../image/icon/Group 2540.png" alt=""></button>Liên Hệ</div>
                                </div>
                                <div class="M-GeneralManagement-right-content2-mobile-text3">
                                    <div class="ul1">
                                        <li id="li1">Dự kiến: <strong>1.500.000đ</strong></li>
