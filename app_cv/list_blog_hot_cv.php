...
$result = array();
$db_qr = new db_query("SELECT new_id,new_title,new_des,new_title_rewrite,new_picture,new_date,adm_name,adm_id FROM news INNER  JOIN admin_user ON news.admin_id = admin_user.adm_id WHERE news.new_category_id = 2 ORDER BY news.new_id DESC LIMIT ".$start.",".$current);
