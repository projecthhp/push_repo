...
function SendMail($title,$name,$email,$body){
  $usernameSmtp = 'AKIA4H45CLBRFUWX2GD6';
  $passwordSmtp = 'BLyn9DJoPiyHcEpkS9QjGPEiqFXDMqrdh0HrbGA+kYtV';  
...
=======
function SendRegisterTVC($email,$nameCandi,$link)
{         
  $body = file_get_contents('../EmailTemplate/01mailxacthucdangkyungvien.htm');
   $body = str_replace('<%name%>', $nameCandi, $body);
>>>>>>> 12bb0cb9ff663446bb65b5a9c100a529c228166a
...
=======
   // SendMail($title,$nameCandi,$email, $body);
>>>>>>> 12bb0cb9ff663446bb65b5a9c100a529c228166a
