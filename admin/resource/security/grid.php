...
foreach($this->arrayLabel as $key=>$lable){
	...
	*/
	...
	function showEditGet($record_id){
		return '<td width="10" align="center"><a class="edit"  rel="tooltip" title="' . translate_text("Bạn muốn sửa bản ghi") . '" href="edit_get.php?record_id=' .  $record_id . '&url=' . base64_encode($_SERVER['REQUEST_URI']) . '"><img src="' . $this->image_path . 'edit.png" border="0"></a></td>';
	}
	function showEditAddAppli($record_id){
		return '<td width="10" align="center"><a class="edit"  rel="tooltip" title="' . translate_text("Bạn muốn sửa bản ghi") . '" href="edit_address.php?record_id=' .  $record_id . '&url=' . base64_encode($_SERVER['REQUEST_URI']) . '"><img src="' . $this->image_path . 'edit.png" border="0"></a></td>';
	}
	function showEditCHPV($record_id){
		return '<td width="10" align="center"><a class="edit"  rel="tooltip" title="' . translate_text("Bạn muốn sửa bản ghi") . '" href="edit_new.php?record_id=' .  $record_id . '&url=' . base64_encode($_SERVER['REQUEST_URI']) . '"><img src="' . $this->image_path . 'edit.png" border="0"></a></td>';
	}
	function showEditGhim($record_id){
		return '<td width="10" align="center"><a class="edit"  rel="tooltip" title="' . translate_text("Bạn muốn sửa bản ghi") . '" href="edit_ghim.php?record_id=' .  $record_id . '&url=' . base64_encode($_SERVER['REQUEST_URI']) . '"><img src="' . $this->image_path . 'edit.png" border="0"></a></td>';
	}
	function showEditTmp($record_id){
		return '<td width="10" align="center"><a class="edit"  rel="tooltip" title="' . translate_text("Bạn muốn sửa bản ghi") . '" href="edit_tmp.php?record_id=' .  $record_id . '&url=' . base64_encode($_SERVER['REQUEST_URI']) . '"><img src="' . $this->image_path . 'edit.png" border="0"></a></td>';
	}
   ...
   function showRenewTin($record_id){
	...
	function showDeleteErr($record_id){
		return '<td width="10"  align="center"><a class="delete" href="#" onclick="if (confirm(\''  . str_replace("'","\'",translate_text("Bạn muốn xóa bản ghi?")) . '\')){ deleteone_err(' . $record_id . '); }"><img src="' . $this->image_path . 'delete.gif" border="0"></a></td>';	
	}
	function showDeleteUT($record_id){
		return '<td width="10"  align="center"><a class="delete" href="#" onclick="if (confirm(\''  . str_replace("'","\'",translate_text("Bạn muốn xóa bản ghi?")) . '\')){ deleteone_ut(' . $record_id . '); }"><img src="' . $this->image_path . 'delete.gif" border="0"></a></td>';	
	}
	function showDeleteTmp($record_id){
		return '<td width="10"  align="center"><a class="delete" href="#" onclick="if (confirm(\''  . str_replace("'","\'",translate_text("Bạn muốn xóa bản ghi?")) . '\')){ deleteone_tmp(' . $record_id . '); }"><img src="' . $this->image_path . 'delete.gif" border="0"></a></td>';	
	}
	...
	function showCheckboxAddAppli($field, $value, $record_id){
		return '<td width="10" align="center"><a class="edit" onclick="update_check(this); return false" href="active_add_appli.php?ajax=1&field=' . $field . '&checkbox=1&record_id=' .  $record_id . '&url=' . base64_encode($_SERVER['REQUEST_URI']) . '"><img src="' . $this->image_path . 'check_' . $value . '.gif" border="0"></a></td>';
	}
