...
$myform->add("idlang", "idlang", 1, 0, 0, 1, translate_text("Bạn chưa chọn ngôn ngữ"), 1, "Đã có bài viết cho ngôn ngữ này");
...
<tr>
    ...
    <td class="form_text">
        <select name="idlang" id="idlang" class="form_control">
