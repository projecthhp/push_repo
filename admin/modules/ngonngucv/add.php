...
$myform->add("name","name",0, 0,"",1,"Bạn chưa nhập tên ngôn ngữ",0,"");
$myform->add("code","code",0, 0,"",1,"Bạn chưa nhập mã viết tắt",1,"Mã viết tắt này đã tồn tại");
...
<?=$form->text("Tên ngôn ngữ","name","name",$name,"Tên ngôn ngữ",1,500,"",255)?>
<?=$form->text("Mã viết tắt","code","code",$code,"Mã viết tắt",1,500,"",255)?>
