...
$list->add("cat_edit_date","Thời gian sửa","string",0, 0,'');
...
<div id="listing">
   ...
   while($rows = mysql_fetch_assoc($db->result)){
      ...
      <td align="center"><a target="_blank" href="https://timviec365.com/mau-thu-xin-viec/<?=$rows['cat_alias']?>.html"><?=$rows['cat_name']?></a> </td>
         ...
         <td align="center"><?=($rows['cat_edit_date']>0)?date("d/m/Y",$rows['cat_edit_date']):""?></td>
         <?if(  $_SESSION["isAdmin"] == 1){?>
