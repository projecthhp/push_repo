...
$myform->add("codecolor","codecolor",0, 0,"",1,"Bạn chưa nhập mã màu",0,"");
$myform->add("serial","serial",0, 0,"",0,"",0,"Bạn chưa nhập thứ tự",0,"");
$myform->add("status","status",0, 0,"",0,"",0,"Bạn chưa nhập trạng thái",0,"");
$myform->add("type","type",0, 0,"",0,"",0,"Bạn chưa nhập loại CV",0,"");
$myform->add("price","price",0, 0,"",0,"",0,"Bạn chưa nhập giá tiền",0,"");
...
<?=$form->text("ID danh mục","idcate","idcate",$idcate,"ID danh mục",1,500,"",255)?>
<?=$form->text("Tên CV","name","name",$name,"Nhập tên mẫu CV",1,500,"",255)?>
...
<tr>
  ...
  <td>
    <select name="idnganh" id="idnganh">
      ...
      ?>
      <option <?= ($idnganh==$key)?"selected":"" ?> value="<?=$key?>"><?=$value['name']?></option>
      <?
      }
      ?>
    </select>
...
<!-- <?=$form->text("ID ngành nghề","idnganh","idnganh",$idnganh,"chọn ID ngành nghề",1,500,"",255)?> -->
...
<?=$form->text("Giá tiền","price","price",$price,"Nhập giá tiền",0,500,"",255)?>
