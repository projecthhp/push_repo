...
if($cat_name_rewrite == ''){
	$cat_name_rewrite 	= removeTitle($cat_name,'/');
...
$myform->add("cat_active","cat_active",1,0,$cat_active,0,"",0,"");
...
$myform->add("cat_title","cat_title",0,0,"",0,translate_text("Vui lòng nhập tiêu đề danh mục"),0,"");
$myform->add("cat_keyword","cat_keyword",0,0,"",0,translate_text("Vui lòng nhập keyword"),0,"");
...
<? 
echo $form->textarea(translate_text("Title danh mục"), "cat_title", "cat_title", $cat_title, translate_text("title"), 0, 600, 100, "", "", "");
echo $form->textarea(translate_text("Keyword danh mục"), "cat_keyword", "cat_keyword", $cat_keyword, translate_text("cat_keyword"), 0, 600, 100, "", "", "");
?>
<input type="hidden" name="cat_active" id="cat_active" value="0" />
<?
if($array_config["description"]==1) echo $form->textarea(translate_text("Description danh mục"), "cat_description", "cat_description", $cat_description, translate_text("description"), 0, 600, 120, "", "", "");
?>
