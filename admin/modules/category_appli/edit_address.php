...
$myform->add("new_title","new_title",0, 0,"",1,"Bạn chưa nhập tiêu đề",0,"Tên ngành nghề đã tồn tại");
$myform->add("new_alias","new_alias",0, 0,"",1,"Bạn chưa nhập Url",0,"");
...
$myform->add("time_edit","time_edit",0,0,"",0,"",0,"");
...
<tr><td class="form_text"><input class="form_control" type="text" id="timeedit" name="time_edit" value="<?=$time_edit;?>" style="display: none;"></td></tr>
<?=$form->errorMsg($errorMsg)?>
<?=$form->text("Tên ngành nghề","new_title","new_title",$new_title,"Tiêu đề",1,500,25,255)?>
<?=$form->text("Url","new_alias","new_alias",$new_alias,"Url",1,500,25,255,'',$readonly)?>
