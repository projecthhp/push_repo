...
#+ Array Category
$menu 	= new menu();
$listAll= $menu->getAllChild("languagecv", "id", "timecreated", 0, "1", "id,name", "id ASC", "", 0);
...
$myform->add("id_lang", "id_lang", 1, 0, 0, 1, translate_text("Bạn chưa chọn ngôn ngữ"), 1, "Đã có bài viết cho ngôn ngữ này");
$myform->add("meta_sapo","meta_sapo",0,0,"",0,"",0,"");
$myform->add("content","content",0,0,"",1,"Bạn chưa nhập nội dung",0,"Bạn chưa nhập nội dung");
$myform->add("meta_tit","meta_tit",0,0,"",0,"",0,"");
$myform->add("meta_des","meta_des",0,0,"",0,"",0,"");
$myform->add("meta_key","meta_key",0,0,"",0,"",0,"");
$myform->add("time_created","time_created",0,0,"",0,"",0,"");
$myform->add("time_edited","time_edited",0,0,"",0,"",0,"");
$myform->add("adm_cr","adm_cr",0,0,"",0,"",0,"");
#+
...
<tr><td class="form_text"><input class="form_control" type="text" id="timecreate" name="time_created" value="<?=$timecreate;?>" style="display: none;"></td></tr>
<tr><td class="form_text"><input class="form_control" type="text" id="timecreate" name="time_edited" value="<?=$timecreate;?>" style="display: none;"></td></tr>
<tr><td class="form_text"><input class="form_control" type="text" id="timecreate" name="adm_cr" value="<?=$admin_id;?>" style="display: none;"></td></tr>
<?=$form->errorMsg($errorMsg)?>
<tr>
    <td class="form_name"><font class="form_asterisk">* </font>Chọn ngôn ngữ</td>
    <td class="form_text">
        <select name="id_lang" id="idlang" class="form_control">
...
<?=$form->text("Tiêu đề tin","new_title","new_title",$new_title,"Tiêu đề tin",1,500,25,255)?>
<?=$form->textarea("Mở bài", "meta_sapo", "meta_sapo", $meta_sapo, "Mô tả", 0, 500, 60, "", "", "")?>
