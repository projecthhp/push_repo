...
$myform->add("adm_update","adm_update",0,0,"",0,"",0,"");
...
<tr><td class="form_text"><input class="form_control" type="text" id="timeedit" name="time_edited" value="<?=$timeedit;?>" style="display: none;"></td></tr>
<tr><td class="form_text"><input class="form_control" type="text" id="adm_update" name="adm_update" value="<?=$admin_id;?>" style="display: none;"></td></tr>
