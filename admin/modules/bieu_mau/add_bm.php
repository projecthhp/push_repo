...
$myform->add("cate_name","cate_name",0, 0,"",1,"Bạn chưa nhập Tên danh mục",1,"Tên danh mục đã tồn tại");
$myform->add("cate_alias","cate_alias",0, 0,"",0,"",0,"");
...
if($action == "submitForm"){
   ...
   $errorMsg .= $myform->checkdata();
	...
	if($errorMsg == ""){
		...
		$record_id 		= $last_id;
		$db_qr = new db_query("UPDATE ".$fs_table." SET cate_alias = '".replaceTitle($cate_name)."' WHERE cate_id = ".$record_id." ");
		//echo $query;exit();
...
<?=$form->text("Tên danh mục","cate_name","cate_name",$cate_name,"Nhập Tên ngành nghề",1,500,"",255)?>
