...
$myform->add("cit_title","cit_title",0,0,"",0,translate_text("Vui lòng nhập Title cho danh mục"),0,"");
$myform->add("cit_description","cit_description",0,0,"",0,translate_text("Vui lòng nhập Desctiption cho danh mục"),0,"");
$myform->add("cit_keyword","cit_keyword",0,0,"",0,translate_text("Vui lòng nhập Keyword cho danh mục"),0,"");
...
<?=$form->close_table();?>
<?=$form->create_table();?>
<?=$form->text("Title","cit_title","cit_title",$cit_title,"Tiêu đề",1,500,"",255)?>
<?=$form->text("Desctiption","cit_description","cit_description",$cit_description,"Desctiption",1,500,'','','')?>
<?=$form->text("Keyword","cit_keyword","cit_keyword",$cit_keyword,"cat_keyword",1,500,'','','')?>
