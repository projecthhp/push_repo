...
$fs_table = ($filed == 'rate_active')?"tbl_rate_company":"tbl_rate_interview";
$filed = 'rate_active';
if($ajax == 1){
	$db_select = new db_query("SELECT " . $filed . " FROM " . $fs_table . " WHERE rate_id = " . $record_id);
...
$db_category	= new db_execute("UPDATE " . $fs_table . " SET " . $filed . " = " . $value . " WHERE rate_id = " . $record_id);
unset($db_category);
