...
$myform->add("code","code",0, 0,"",1,"Bạn chưa nhập mã viết tắt",0,"");
...
<?=$form->text("Nhập Tên ngôn ngữ","name","name",$name,"Nhập tên ngôn ngữ",1,500,"",255)?>
<?=$form->text("Nhập mã viết tắt","code","code",$code,"Nhập số tiền",1,500,"",255)?>
