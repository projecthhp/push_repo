...
$url 				= base64_decode(getValue("url","str","GET",base64_encode("listing_ls.php")));
$fs_redirect	= base64_decode(getValue("returnurl","str","GET",base64_encode("listing_ls.php")));
