...
$myform->add("cat_title","cat_title",0,0,"",0,translate_text("Vui lòng nhập Title cho danh mục"),0,"");
$myform->add("cat_description","cat_description",0,0,"",0,translate_text("Vui lòng nhập Desctiption cho danh mục"),0,"");
$myform->add("cat_keyword","cat_keyword",0,0,"",0,translate_text("Vui lòng nhập Keyword cho danh mục"),0,"");
$myform->add("cat_mota","cat_mota",0,0,"",0,translate_text("Vui lòng nhập mô tả cho danh mục"),0,"");
$myform->add("cat_h1","cat_h1",0,0,"",0,translate_text("Vui lòng nhập thẻ H1 cho danh mục"),0,"");
...
<?=$form->create_table();?>
<?=$form->text("Title","cat_title","cat_title",$cat_title,"Tiêu đề",1,500,"",255)?>
<?=$form->text("Desctiption","cat_description","cat_description",$cat_description,"Desctiption",1,500,'','','')?>
<?=$form->text("Keyword","cat_keyword","cat_keyword",$cat_keyword,"cat_keyword",1,500,'','','')?>
<?=$form->text("H1","cat_h1","cat_h1",$cat_h1,"cat_h1",1,500,'','','')?>
<?=$form->wysiwyg("Mô tả danh mục", "cat_mota", $cat_mota, "../../resource/ckeditor/", "50%","600")?>
