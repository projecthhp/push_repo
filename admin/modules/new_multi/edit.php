...
//Lay loai modul
$queryCat   = "SELECT * FROM new_multi WHERE new_id = " . intval($new_category_id);
...
$myform->add("new_mota","new_mota",0,0,"",0,"",0,"");
$myform->add("new_yeucau","new_yeucau",0,0,"",0,"",0,"");
$myform->add("new_quyenloi","new_quyenloi",0,0,"",0,"",0,"");
$myform->add("new_ho_so","new_ho_so",0,0,"",0,"",0,"");
...
if($action == "submitForm"){
	...
	if($errorMsg == ""){
		...
		$fs_redirect 	= $after_save_data. "?record_id=".$record_id."&category=".getValue("new_id","int","POST");
...
<?=$form->close_table();?>
<?=$form->wysiwyg("Mô tả", "new_mota", $new_mota, "../../resource/ckeditor/", "99%", 300)?>
<?=$form->wysiwyg("Quyền lợi", "new_quyenloi", $new_quyenloi, "../../resource/ckeditor/", "99%", 300)?>
<?=$form->wysiwyg("Yêu cầu", "new_yeucau", $new_yeucau, "../../resource/ckeditor/", "99%", 300)?>
<?=$form->wysiwyg("Hồ sơ", "new_ho_so", $new_ho_so, "../../resource/ckeditor/", "99%", 300)?>
