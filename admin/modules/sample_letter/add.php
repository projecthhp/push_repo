...
$myform->add("idnganh","idnganh",0, 0,"",0,"Bạn chưa chọn ID ngành nghề",0,"");
  ...
  $errorMsg .= $myform->strErrorField ; //Check Error!
   ...
   if($array_config["image"]==1){
    ...
    if ($upload_pic->file_name != ""){
      ...
      $fs_filepath_re = '../../../upload/letter/'.$alias . "/";  
      is_dir('../../../upload/letter/'.$alias) || @mkdir('../../../upload/letter/'.$alias,0777,true) || die("Can't Create folder");
...
<?=$form->text("Tên thư","name","name",$name,"Nhập tên mẫu thư",1,600,30,255)?>
<?=$form->text("Tên thư(không dấu)","alias","alias",$alias,"Nhập tên thư không dấu",1,600,30,255)?>
...
<?=$form->textarea("Chuỗi Json HTML ngỗn ngữ VN","htmlcss_vi","htmlcss_vi",$htmlcss_vi,"",1,600,300,255)?>
<?=$form->textarea("Chuỗi Json HTML ngỗn ngữ EN","htmlcss_en","htmlcss_en",$htmlcss_en,"",1,600,300,255)?>
<?=$form->textarea("Chuỗi Json HTML ngỗn ngữ JP","htmlcss_jp","htmlcss_jp",$htmlcss_jp,"",1,600,300,255)?>
<?=$form->textarea("Chuỗi Json HTML ngỗn ngữ CN","htmlcss_cn","htmlcss_cn",$htmlcss_cn,"",1,600,300,255)?>
<?=$form->textarea("Chuỗi Json HTML ngỗn ngữ KR","htmlcss_kr","htmlcss_kr",$htmlcss_kr,"",1,600,300,255)?>
<?=$form->text("Mã màu","codecolor","codecolor",$codecolor,"Chọn mã màu",1,600,30,255)?>
<?=$form->text("Thứ tự","serial","serial",$serial,"Điền thứ tự",1,600,30,255)?>
<?=$form->close_table();?>
<?=$form->create_table();?>
