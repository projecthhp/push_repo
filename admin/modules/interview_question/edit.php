...
$myform->add("ch_alias","ch_alias",0, 0,"",1,"Bạn chưa nhập Url",0,"");
...
$db_qr = new db_query("SELECT * FROM tbl_chpv WHERE ch_id = ".$record_id);
...
<?=$form->text("Tên danh mục","ch_name","ch_name",$row['ch_name'],"Nhập Tên ngành nghề",1,500,"",255)?>
...
<?=$form->textarea("Nội dung mô tả","content","content",$row['content'],"Nhập nội dung mô tả",0,500,150,255)?>
