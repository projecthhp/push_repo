...
echo("<channel>");
echo("<title>Tìm việc miễn phí - Tin tuyển dụng update hàng ngày - Timviec365.com</title>");
echo("<link>https://timviec365.com</link>");
...
?>
	...
	<link><![CDATA[ <?php echo 'https://timviec365.com/'.replaceTitle($row['new_title'])."-".$row['new_id'].".html"; ?>]]></link>
	<description><![CDATA[ 
		...
		<p><?php echo $ar[$i].': '; ?><a href="<?php echo 'https://timviec365.com/'.replaceTitle($row['new_title'])."-".$row['new_id'].".html"; ?>"><?php echo $row['new_title']; ?></a></p>
		]]>
			
	</description>
	<guid isPermaLink="false"><![CDATA[ <?php echo 'https://timviec365.com/'.replaceTitle($row['new_title'])."-".$row['new_id'].".html"; ?>]]></guid>
	</item>
