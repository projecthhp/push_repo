...
if($TxtCard != 0 && $TxtMaThe != '' && $TxtSeri != '')
{
  ...
  $username="timviec365";
  $password="timviec365@12354";
  $partnerId =184;
  $mpin="timviec365.vn.mpin";
  ...
  //$target ten member nap card cua doi tac
   ...
   if($userid != 0 && $amount > 0)
   {
      ...
      $db_ex9 = new db_execute("UPDATE user_company SET usc_money = usc_money + ".$amount." WHERE usc_id = ".$userid."");
   }
